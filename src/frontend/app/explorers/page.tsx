  ...
  return (
    <main className="mx-auto max-w-3xl p-6">
      ...
      <p className="mt-2 text-sm opacity-80">
        ...
        page remains the Phase 1 pie until M12 cutover. Contracts, grants, ACT
        notifiable invoices, PBS and VIC output performance are now all powered by one
        registry-driven shell (<code>ExplorerShell.tsx</code>, item 6.2/6.3) rather than
        per-page hard-coded logic.
      </p>
      <ul className="mt-6 list-disc space-y-2 pl-6">
        ...
        <li>
          <Link href="/explorers/qld-otp">QLD on-time payments (small business)</Link>
        </li>
        <li>
