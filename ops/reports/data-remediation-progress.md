...
| 8.1 Pre-2019 FBO parsers | in_progress | Two sub-generations built and live: FY2010-11..FY2013-14 Appendix A function-level series (20 measures: 13 COFOG-style functions + 5 "Other purposes" line items + Total other purposes + Total expenses), verified as two distinct column layouts (3-column FY2010-11/FY2011-12; 4-column with a trailing "Change on Budget" FY2012-13/FY2013-14), never assumed uniform. Extraction independently proven correct across all 4 years: the 5 Other purposes items sum to the published Total other purposes exactly for 3 of 4 years and within $1m for FY2012-13; the 13 functions plus Total other purposes sum to Total expenses exactly for FY2011-12 and within $1-2m (well under 0.001%, genuine source rounding) for the other 3 years. 80 facts, 20 nodes live (0 new nodes on the second sub-generation - same 20 measure_types, more years), 0 quarantine, idempotent on re-apply, 0 task9 hard failures, 0 canonical-tree impact. 17 new tests total (15 + 2), 811 total passed | `cf7ce1e` (scoping), `faf417a` (3-column build), `86163fa` (4-column extension) | FY2014-15..FY2016-17 (different header wording), FY2017-18/FY2018-19 (table not yet located), and the entire pre-2010-11 population each remain their own dedicated future investigation (see scoping reports) |
