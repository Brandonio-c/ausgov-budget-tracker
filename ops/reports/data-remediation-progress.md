...
| 8.1 Pre-2019 FBO parsers | in_progress | First slice built and live: FY2010-11/FY2011-12 Appendix A function-level series (20 measures: 13 COFOG-style functions + 5 "Other purposes" line items + Total other purposes + Total expenses). A further page-boundary investigation inside the originally-recommended FY2010-11..FY2013-14 "stable" cluster found a real column-count split within it - FY2012-13/FY2013-14 add a 4th "Change on Budget" numeric column not present in FY2010-11/FY2011-12 - narrowing the safely-buildable-in-one-pass slice to 2 years, not 4. Extraction independently proven correct: the 5 Other purposes items sum exactly to the published Total other purposes for both years; the 13 functions plus Total other purposes sum to Total expenses exactly for FY2011-12 and within $2m/0.0006% (genuine source rounding) for FY2010-11. 40 facts, 20 nodes live, 0 quarantine, idempotent on re-apply, 0 task9 hard failures, 0 canonical-tree impact. 15 new tests, 809 total passed | `cf7ce1e` (scoping), `<pending>` (build) | FY2012-13/FY2013-14 (4-column variant), FY2014-15..FY2016-17 (different header wording), FY2017-18/FY2018-19 (table not yet located), and the entire pre-2010-11 population each remain their own dedicated future investigation (see scoping reports) |
