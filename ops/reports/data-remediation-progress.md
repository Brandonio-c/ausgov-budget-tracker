...
| 8.1 Pre-2019 FBO parsers | in_progress | Three sub-generations built and live: FY2010-11..FY2016-17 Appendix A function-level series (20 measures: 13 COFOG-style functions + 5 "Other purposes" line items + Total other purposes + Total expenses), verified as two distinct column layouts (3-column FY2010-11/FY2011-12; 4-column with a trailing "Change on Budget" FY2012-13..FY2016-17), never assumed uniform. **Correction to the original scoping pass**: FY2014-15..FY2016-17 were originally excluded as having "different header wording"; a direct re-check with the extractor's own (already case-insensitive) anchor regex found they use the identical layout/anchor as FY2012-13/FY2013-14 - the original finding predated the case-insensitivity fix, not a real layout difference. Extraction independently proven correct across all 7 years: the 5 Other purposes items sum to the published Total other purposes exactly for 5 of 7 years and within $1m for the other 2; the 13 functions plus Total other purposes sum to Total expenses exactly for 2 of 7 years and within $1-2m (well under 0.001%, genuine source rounding) for the other 5. 140 facts, 20 nodes live (0 new nodes on the 2nd/3rd sub-generations - same 20 measure_types, more years), 0 quarantine, idempotent on re-apply, 0 task9 hard failures, 0 canonical-tree impact. 17 tests total, 811 total passed | `cf7ce1e` (scoping), `faf417a` (3-column build), `86163fa` (4-column extension), `<pending>` (FY2014-17 re-check+load) | FY2017-18/FY2018-19 (table not yet located) and the entire pre-2010-11 population (FY1998-99..FY2009-10) remain their own dedicated future investigation (see scoping reports) |
