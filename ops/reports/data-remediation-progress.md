...
| 8.1 Pre-2019 FBO parsers | in_progress | Page-anchor scoping done before writing any parser code: the earlier triage's "internally consistent 2010-11-2018-19 cluster" recommendation is itself not internally consistent - a distinctive page-anchor string, confirmed stable for FY2010-11, was checked across all 9 candidate years and found at least 4 distinct sub-generations within that single recommended cluster (FY2010-11..FY2013-14 genuinely stable; FY2014-15..FY2016-17 uses different header wording; FY2017-18..FY2018-19's real Appendix A sub-function table was not located at all - its anchor hit was a false-positive Table-of-Contents match, and its real page (18) has only the same function-level-only summary table the broad parser already contaminates on). No extractor code written | — | FY2010-11..FY2013-14 (4 years, confirmed stable anchor) is the genuinely tractable next slice; the other 3+ sub-generations (FY2014-15..FY2016-17, FY2017-18..FY2018-19, and the entire pre-2010-11 population) each need their own dedicated investigation (see scoping report) |
