...
| 8.1 Pre-2019 FBO parsers | in_progress | 15 years now live: FY2004-05..FY2018-19 Appendix A/B function-level series (20 measures each, 300 facts). Extended backward twice more this pass: FY2007-08/FY2008-09/FY2009-10 (identical "Appendix A"/3-column/column-2 layout as FY2010-11+, after fixing a footnote-marker gap and a real number-parsing defect - a stray space inside a large number in the 2008-09 file silently mis-splitting a value, caught only via the $6,113m published-total cross-check mismatch, not any structural signal), then FY2004-05/FY2005-06/FY2006-07 (titled "Appendix B" not "A" - anchor widened to accept either letter - same 3-column/column-2 layout, after finding and fixing 3 more real, evidence-confirmed label defects: title-cased labels in the 2004-05 file ("Total Transport and Communication"), an ampersand variant of one label ("Mining, manufacturing & construction"), and further footnote markers on 2 more labels - each fix generalized across all 20 labels rather than patched individually once the pattern recurred a 3rd/4th time, and **every fix re-verified to change zero values on every already-loaded year before being applied**. All 15 loaded years hold both published cross-checks within $0-2m (immaterial rounding). **Also scoped (not built) the remaining FY1998-99..FY2003-04 population**: a 2-column layout (FY1999-00/2000-01), a 3-column layout with Estimate at Outcome in column 3 not 2 (FY2001-02/FY2002-03 - the same column-order trap already caught for FY2017-19), 3 files needing a newly-discovered but unbuilt font-decode step (a consistent +29 character-code shift), and FY1998-99 itself which has no such table at all (predates accrual/functional reporting). See `ops/reports/fbo-pre-2010-scoping-20260819T182500Z.md`. 23 tests total, 817 total passed | `cf7ce1e` (scoping), `faf417a` (3-col build), `86163fa` (4-col ext), `9dbfad2` (FY2014-17), `e53e65f` (5-col FY2017-19), `2182962` (FY2007-09 ext), `<pending>` (FY2004-06 "Appendix B" ext) | FY1998-99..FY2003-04 (5 tractable years + 1 genuine absence) remain, each needing its own dedicated build pass per the scoping report's findings - never merged into an existing generation without individual verification |
