...
| 8.1 Pre-2019 FBO parsers | in_progress | 12 years now live: FY2007-08..FY2018-19 Appendix A function-level series (20 measures each). Extended backward into FY2007-08/FY2008-09/FY2009-10 - the identical "Appendix A"/3-column/column-2 layout already loaded for FY2010-11+ - after finding and fixing 2 real defects: (1) "Defence"/"Contingency reserve" carry a footnote letter with no space ("Defence(a)") in these years, breaking the label regex; (2) the 2008-09 file's own PDF text extraction inserts a stray space inside a large number ("5, 926" for "5,926"), which the prior bare-digit-run number pattern would silently mis-split, shifting every later column - caught only because the published-total cross-check was off by $6,113m for that one year, not by any structural failure. Fixed the shared number pattern to require exact 3-digit comma groups; **re-verified this changes zero values across all 9 previously-loaded years** before applying. All 12 loaded years now hold their cross-checks within $0-2m (immaterial rounding). 60 new facts (180->240 total facts for this source), 0 new nodes, 0 quarantine, idempotent, 0 task9 hard failures, 0 canonical-tree impact. **Also scoped (not built) the remaining FY1998-99..FY2006-07 population**: found it is far more heterogeneous than anything loaded so far - an "Appendix B" naming era (not "A"), a 2-column layout (FY1999-00/2000-01), a 3-column layout with Estimate at Outcome in column 3 not 2 (FY2001-02..FY2003-04 - the same column-order trap already caught once for FY2017-19), 3 files needing a newly-discovered but unbuilt font-decode step (a consistent +29 character-code shift), and FY1998-99 itself which has no such table at all (predates accrual/functional reporting). See `ops/reports/fbo-pre-2010-scoping-20260819T182500Z.md`. 21 tests total (3 new), 815 total passed | `cf7ce1e` (scoping), `faf417a` (3-col build), `86163fa` (4-col ext), `9dbfad2` (FY2014-17), `e53e65f` (5-col FY2017-19), `2182962` (FY2007-09 ext + pre-2010 scoping) | FY1998-99..FY2006-07 (7 tractable years + 1 genuine absence) remain, each needing its own dedicated build pass per the scoping report's findings - never merged into an existing generation without individual verification |
