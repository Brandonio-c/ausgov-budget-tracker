# Dashboard API traversal audit — 20260803T215700Z

Base URL: `http://127.0.0.1:8000` (real backend against `data/facts.db`)

**Total hard failures across all paths: 3**
...
| federal_budget_latest | 1647 | 0 | 0 | 0 | 0 | 0 | 3 | 0 | 0 |
...
- `federal_budget_latest`: {"path": "federal_budget_latest", "fact_id": 350609, "name": "(accumulated deficit)", "reason": "unknown", "rejection_reason": "no_confident_signal"}
- `federal_budget_latest`: {"path": "federal_budget_latest", "fact_id": 337011, "name": "operating", "reason": "narrative_fragment", "rejection_reason": "starts_lowercase"}
- `federal_budget_latest`: {"path": "federal_budget_latest", "fact_id": 336951, "name": "workforce", "reason": "narrative_fragment", "rejection_reason": "starts_lowercase"}
